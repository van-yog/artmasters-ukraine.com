          ...
          {this.state.gallery.map((item, idx) => {
            ...
            return (
              <a
                ...
                href={`../src/img/artists/lyzogub_kostyantyn/react-gallery/${
                  idx + 1
                }.jpg`}
                target="_blank"
              >
                <img
                  ...
                  src={`../src/img/artists/lyzogub_kostyantyn/react-gallery/${
                    idx + 1
                  }.jpg`}
                />
              </a>
...
ReactDOM.render(<App imgs={1} />, root);
